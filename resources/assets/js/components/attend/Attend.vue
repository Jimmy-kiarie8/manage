<template>
  ...
  <div class="panel-heading">
    <button class="button is-primary is-outlined pull-right" @click="openAdd">Report</button> 
  ...
  <table class="w3-table w3-striped w3-bordered w3-border w3-white">
    ...
    <myattendadd :openmodal='addActive' @closeRequest="close"></myattendadd>
    <myattendshow :openmodal='showActive' @closeRequest="close"></myattendshow>
    <myattendupdate :openmodal='updateActive' @closeRequest="close"></myattendupdate>
</div>
</template>

<script>
let myattendadd = require('./AttendAdd.vue');
let myattendshow = require('./AttendShow.vue');
let myattendupdate = require('./AttendUpdate.vue');
export default {
    props : ['user'],
      components: {
        myattendadd, myattendshow, myattendupdate
      },
    data() {
      return{
      // alert: false,
    ...
    methods: {
      ...
      close() {
        this.addActive = this.showActive = this.updateActive = this.activate = ""
